    ...
    <div class="offset-md-3 col-md-6">
      <div class="card ">
          <div class="card-header ">
            <h4 class="card-title">Nueva Operacion</h4>
          </div>
    @if(session()->has('info'))
      <h3>{{session('info')}}</h3>
    @else
        <div class="card-body ">
            <form style="width: 100%;" method="POST" action="{{route('operacion.store')}}">    
              {!!csrf_field()!!}     
                  ...
                  <div class="form-group"><input class="form-control" type="text" name="orden" value="{{old('orden')}}">
