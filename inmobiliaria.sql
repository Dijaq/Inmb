...
CREATE TABLE `ubi_provincias` (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (region_id) REFERENCES ubi_regiones(id)
); 
...
CREATE TABLE `ubi_distritos` (
  `id` char(6) NOT NULL DEFAULT '',
  `nombre` varchar(50) NOT NULL DEFAULT '',
  `info_busqueda` varchar(256) NOT NULL DEFAULT '',
  `provincia_id` char(6) DEFAULT NULL,
  `region_id` char(6) NOT NULL DEFAULT '',
	PRIMARY KEY (id),
	FOREIGN KEY (provincia_id) REFERENCES ubi_provincias(id),
	FOREIGN KEY (region_id) REFERENCES ubi_regiones(id)
);
...
CREATE TABLE `personas` (
  ...
  `cargo_empresa` varchar(32) DEFAULT '',
  `correo` varchar(255) DEFAULT '',
  `telefono` varchar(255) DEFAULT '',
  `celular1` varchar(255) DEFAULT '',
  `celular2` varchar(255) DEFAULT '',
  `celular3` varchar(255) DEFAULT '',
  `info_busqueda` varchar(255) DEFAULT '',
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE inmueble(
	...
	ubigeo_provincia_id char(6) NOT NULL ,
	ubigeo_distrito_id char(6) NOT NULL,
	ubigeo_region_id char(6) NOT NULL,
	moneda VARCHAR(4),
	titulo VARCHAR(256),
	slug VARCHAR(256),
	...
	FOREIGN KEY (ubigeo_distrito_id) REFERENCES ubi_distritos(id),
    FOREIGN KEY (ubigeo_provincia_id) REFERENCES ubi_provincias(id),
    FOREIGN KEY (ubigeo_region_id) REFERENCES ubi_regiones(id)
);
...
CREATE TABLE atributo_inmueble(
	id INT NOT NULL AUTO_INCREMENT,
